              ...
              <div class="col-lg-8 col-md-8 col-sm-8">
                  <div class="card card-primary">
                    <div class="card-header">
                      <h3 class="card-title">Service Post</h3>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form  action="{{url('editor/service/store')}}" method="POST" enctype="multipart/form-data">
                      @csrf
                      <div class="card-body">

                        <div class="col-sm-12">
                          <div class="form-group">
                              <label for="servicecategory_id">Service Category <span>*</span></label>
                        ...
                        <div class="col-sm-12">
                          <div class="form-group">
                              ...
                              <textarea name="overview" id="overview" cols="30" rows="10" class="summernote form-control {{ $errors->has('overview') ? ' is-invalid' : '' }}" >{{ old('overview') }}</textarea>
