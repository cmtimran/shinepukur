          ...
          <div class="col-sm-12">
            <div class="manage-button">
              ...
              <div class="quick-button">
                <a href="{{url('admin/gallery/create')}}" class="btn btn-primary btn-actions btn-create">
                Create Gallery
                </a>
              </div>
            </div>
                        ...
                        <tr>
                          ...
                          <td><ul class="action_buttons dropdown">
                              ...
                              <ul class="dropdown-menu">
                                <li>
                                  @if($value->status==1)
                                  <form action="{{url('admin/gallery/inactive')}}" method="POST">
                                    @csrf
                                  ...
                                  <li>
                                      <a class="edit_icon" href="{{url('admin/gallery/edit/'.$value->id)}}" title="Edit"><i class="fa fa-edit"></i> Edit</a>
                                  </li>
                                  <li>
                                    <form action="{{url('admin/gallery/delete')}}" method="POST">
                                      @csrf
                                      <input type="hidden" name="hidden_id" value="{{$value->id}}">
