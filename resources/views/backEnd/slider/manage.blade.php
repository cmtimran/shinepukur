          ...
          <div class="col-sm-12">
            <div class="manage-button">
              ...
              <div class="quick-button">
                <a href="{{url('admin/slider/create')}}" class="btn btn-primary btn-actions btn-create">
                Create Slider
                </a>
              </div>
            </div>
                          ...
                          <td><ul class="action_buttons dropdown">
                              ...
                              <ul class="dropdown-menu">
                                <li>
                                  ...
                                  <li>
                                      <a class="edit_icon" href="{{url('admin/slider/edit/'.$value->id)}}" title="Edit"><i class="fa fa-edit"></i> Edit</a>
                                  </li>
                                  <li>
