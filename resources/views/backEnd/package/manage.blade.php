                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                              ...
                              @if($value->id==$image->product_id) <img src="{{asset($image->image)}}" alt="" class="small_image" style="height:50px; width:50px;">
                              @endif
                              @endforeach
                          </td>
                          <td>{{$value->title}}</td>
                          ...
                          <td><ul class="action_buttons dropdown">
                              ...
                              <ul class="dropdown-menu">
                                <li>
                                  ...
                                  <li>
                                      <a class="edit_icon" href="{{url('admin/package/edit/'.$value->id)}}" title="Edit"><i class="fa fa-edit"></i> Edit</a>
                                  </li>
                                  <li>
                                    <form action="{{url('admin/package/delete')}}" method="POST">
                                      @csrf
                                      <input type="hidden" name="hidden_id" value="{{$value->id}}">
